...
if ($ubt1 != 0 And $ubt1 != 1) $ubt1 = 0;

if ($ubt2 != 0 And $ubt2 != 1) $ubt2 = 0;
...
for ($i = 0; $i <= $num_to_use; $i++) {
	...
	if ($i <= $last_planet_num - 4) drawboldtext($im, 16, 0, $margins + $left_margin_planet_table, $cell_height + $cell_height * ($i + 1), $blue, 'HamburgSymbols.ttf', chr($pl_glyph[$i]), 0);
