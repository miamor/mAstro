	<link rel="stylesheet" type="text/css" href="<? echo PLUGINS ?>/mchat/zzchat.css" />
	<? if ($tmID != 0) echo '<script>var MAIN_URL = "'.MAIN_URL.'"; var teamID = '.$tmID.'; var roomID = '.$tID.'; var meName = "'.$config->me['name'].'"; var cURL = "'.MAIN_URL.'/chat?p='.$params.'&do=update";</script>';
	...
	<audio id="chatbox-buzz-audio">
		<source src="<? echo PLUGINS ?>/mchat/sound/buzz.ogg" type="audio/ogg" />
		<source src="<? echo PLUGINS ?>/mchat/sound/buzz.mp3" type="audio/mpeg" />
	</audio>
	<audio id="chatbox-new-audio">
		<source src="<? echo PLUGINS ?>/mchat/sound/new.mp3" type="audio/mpeg" />
	</audio>

	<script type="text/javascript" src="<? echo PLUGINS ?>/mchat/zzchat.js"></script>
